...
1. Периодически (периодичность задается в env PGSQL_PERIOD = '3600' в секундах), сервис должен запрашивать из РНИС следующие сущности:
...
В настройках контейнера необходимо ограничить размер контейнера до 256MB
