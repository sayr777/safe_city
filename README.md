...
[GET] http://IP:PORT/v.1/vehicles_dic

header {

'Authorization' = 'Basic SU5GT0BUMS1HUk9VUC5SVTo2OTNWQ3U=',
...
[GET] http://IP:PORT/v.1/messages/org_id:\<path:org_id
...
-   'TOKEN' = ['213d3f34gvb%fgd45HJH', '43S23df\$sd34H43QEA'] \# список ключей
    доступа. Тип LIST
